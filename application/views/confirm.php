...
<!--        <link rel="stylesheet" href="<?php echo base_url('assets/css/style.css'); ?>" />-->
    ...
    <body>
        ...
        <section class="login">
            ...
            <?php echo form_open(base_url('outside/close')); ?>
            <span>Are you sure want to close this contract?</span><br><br>
            <table>
                <tr>
                    <td>Doc No</td>
                    <td>:</td>
                ...
                <tr>
                    <td>Period</td>
                    <td>:</td>
                    <td><?php echo date('d/m/Y', strtotime($this->input->get('fd'))); ?> - <?php echo date('d/m/Y', strtotime($this->input->get('td'))); ?></td>
                </tr>
                <tr>
                    <td>Desc</td>
                    <td>:</td>
